"use client";
/* TODO: BG colors made from logo colors; Waves like an ocean; Animated? */
...
export default function Page() {
    try {
        const choice = getCookie(gsnDisclaimerChoice) !== undefined ? "agreed" : "did not agree"; // Retrieve from user's session data as well as this cookie 
