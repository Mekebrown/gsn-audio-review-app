...
export default function Page() {
    try {
        ...
        return <section>
            ...
            <Link href={baseURLString + "/about/ntks/disclaimer"}>Disclaimer</Link>
            <Link href={baseURLString + "/about/ntks/faq"}>FAQ</Link>
            <Link href={baseURLString + "/about/ntks/pricing"}>Pricing</Link>
            <Link href={baseURLString + "/about/ntks/privacy"}>Privacy</Link>
            <Link href={baseURLString + "/about/ntks/sitemap"}>Sitemap</Link>
            <Link href={baseURLString + "/about/ntks/terms"}>Terms</Link>
        </section>;
    } catch (error: any) {
